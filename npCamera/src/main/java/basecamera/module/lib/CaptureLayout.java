...
//                resetCaptureLayout();
        ...
        //返回按钮
        btn_return = new ReturnButton(getContext(), buttonWH);
        ...
        LayoutParams iv_custom_param_right = new LayoutParams(buttonWH, buttonWH);
        iv_custom_param_right.gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
        iv_custom_param_right.setMargins(0, 0, layout_width / 8, 0);
