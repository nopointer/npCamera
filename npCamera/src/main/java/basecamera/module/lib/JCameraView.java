...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.mipmap.basecamera_icon_flip);
        iconLeft = a.getResourceId(R.styleable.JCameraView_iconLeft, R.mipmap.basecamera_icon_back);
        iconRight = a.getResourceId(R.styleable.JCameraView_iconRight, R.mipmap.basecamera_icon_gallery);
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.basecamera_camera_view, this);
