...
class StatusBarHelperUtils {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(DeviceHelperUtils.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (DeviceHelperUtils.isMeizu() || (DeviceHelperUtils.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (DeviceHelperUtils.isZTKC2016()) {
            return false;
        }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (DeviceHelperUtils.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return DeviceHelperUtils.isMIUIV5() || DeviceHelperUtils.isMIUIV6() ||
                DeviceHelperUtils.isMIUIV7() || DeviceHelperUtils.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(DeviceHelperUtils.isZUKZ1() || DeviceHelperUtils.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (DeviceHelperUtils.isTablet(context)
                && sStatusbarHeight > DisplayHelperUtils.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
